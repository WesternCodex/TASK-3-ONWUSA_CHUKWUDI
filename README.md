# TASK-3-ONWUSA_CHUKWUDI
Sales dataset using SQL to uncover customer behavior, product performance, sales trends, and payment preferences.
...
* Checked coupon and referral usage
